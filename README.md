...
Flutter-App zur Steuerung des ESP32-S3-Touch-AMOLED-1.43 Augen-Paars via BLE (466x466-AMOLED,
Master↔Slave-Sync über Kabel). Cloud-Augen werden als 466x466-RGB565-Bilder hochgeladen.

> OLED-Variante von `eye_pair_app` (die 240x240-App bleibt für die alten GC9A01-Boards bestehen).
